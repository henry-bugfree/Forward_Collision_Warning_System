...
struct camera_information {
    float   focalLengthX = 874;
    float   focalLengthY = 995;
    float   opticalCenterX = 960;
    float   opticalCenterY = 536;
    float   pitch = -3.1;
    float   yaw = 6.6;
    float   width = 1920;
    float   height = 1080;
    float   cam_height = 430*3;
}cam_info;
...
int saveinfo()
{
    ...
    //300cm c1:(874, 664) c2:(1337, 1006)
    //500cm c1:(955, 650) c2:(1242, 843)
    //750cm c1:(970, 638) c2:(1157, 759)
    //1000cm c1:(994, 627) c2:(1136, 720)
    //1200cm c1:(1004, 627) c2:(1118, 700)
    //1500cm c1:(1019, 622) c2:(1107, 679)
    //2000cm c1:(1047, 618) c2:(1092, 660)

    //300cm 1013,1337changes to this:1060,867
    //500cm 845,1242changes to this:955,872
    //750cm 759,1157changes to this:817,859*
    //1000cm 720,1136changes to this:696,860
    //1200cm 700,1118changes to this:600,855*
    //1500cm 679,1107changes to this:454,855
    //2000cm 660,1092changes to this:246,848
}
...
int main()
{
       ...
       int object_id;
       string label;
       outfile.open("./share/dist-from_yolo.txt");
